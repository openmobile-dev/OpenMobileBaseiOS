...
@class OMCManagerType, OMCKotlinEnumCompanion, OMCKotlinEnum<E>, OMCManagerTypeCompanion, OMCKotlinArray<T>, OMCOpenMobileCore, OMCOpenMobileActions, OMCNetworkActions, OMCNotificationsActions, OMCOpenMobileActionsCompanion, OMCOpenMobileActionsNETWORK_GET, OMCOpenMobileActionsNETWORK_POST, OMCOpenMobileActionsNOTIFICATION_DEREGISTER_DEVICE_PUSH_TOKEN, OMCOpenMobileActionsNOTIFICATION_HANDLE_PUSH_MESSAGE, OMCOpenMobileActionsNOTIFICATION_REGISTER_DEVICE_PUSH_TOKEN, OMCOpenMobileActionsNOTIFICATION_SHOW_NOTIFICATION, OMCOpenMobileActionsUI_BUILD_INTENT, OMCOpenMobileActionsUI_DISMISS_INTENT, OMCOpenMobileActionsUI_LAUNCH_INTENT, OMCOpenMobileActionsUI_OPEN_URL, OMCOpenMobileActionsUI_SHOW_TOAST, OMCUIActions, OMCKotlinThrowable, OMCKotlinException, OMCKotlinRuntimeException, OMCKotlinIllegalStateException;
